...
class TodoListArea extends Component {
  ...
  renderDragableTodoItem = (todoData, i) => (provided, snapshot) => (
    <div>
      <div
  ...
  render() {
    const filteredTabmodeTodos = filterTodoListByCurrTabMode(
      this.props.todoList,
      this.props.appMode.visibilityTodoMode,
    )
    return (
      <div>
