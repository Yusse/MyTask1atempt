...
const handleIsAdd_or_Edit_ButtonArea = (props, onButtonConfirmClickHandler) => {
  if (props.appMode.inAdd) {
    return (
      <ButtonArea
        toggleAppModeCB={props.toggleAppInNewAddTodoMode}
        onConfirm={onButtonConfirmClickHandler}
      />
    )
  }
  ...
  return (
    <ButtonArea
      toggleAppModeCB={props.toggleAppInEditingTodoMode}
      onConfirm={onButtonConfirmClickHandler}
    />
  )
}
